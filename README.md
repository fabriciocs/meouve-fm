...
To build the final jar and optimize the meouvefm application for production, run:
...
Then navigate to [http://localhost:45550](http://localhost:45550) in your browser.
